...
namespace CSharpSynth.Banks.Sfz
{
    public class SfzInstrument : Instrument
    {
            ...
            : base()
        {
            ...
            //Debug.Log("Reading: " + Instrumentfile);
            TextAsset instrumentFile = Resources.Load<TextAsset>(Instrumentfile); // as TextAsset;
                                    ...
                                    if (Rvalue.Length == 2)
                                    {
                                        switch (Rvalue[0])
                                        {
                                            ...
                                            case "ampeg_release":
                                                ...
                                                Debug.Log("ampeg_release: " + Group.Release + " actual value: " + float.Parse(Rvalue[1], CultureInfo.InvariantCulture) + " samplerate used: " + this.SampleRate + " preparse value: " + Rvalue[1]);
                                                break;
                                            case "ampeg_attack":
                                                groupValues[10] = true;
